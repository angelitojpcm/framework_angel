 ...
 * Clase Flasher
 * 
 * Esta clase proporciona métodos para guardar y renderizar notificaciones flash.
 * Las notificaciones flash son mensajes que se muestran al usuario durante una sesión y luego se eliminan.
 * Las notificaciones pueden tener diferentes tipos, como primario, secundario, éxito, peligro, advertencia, información, luz y oscuro.
 * 
 * @package app\classes
 */
<?php 
